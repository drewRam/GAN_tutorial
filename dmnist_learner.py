...
def generate_and_save_images(model, epoch, test_input):
  ...
  #try closing here and see if it gets rid of warning - if not try else where
  plt.close()
  print("Closed")
...
# Call the train() method defined above to train the generator and discriminator simultaneously. Note, training GANs can be tricky.
